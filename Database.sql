...
CREATE TABLE referencias.revisiones(marca VARCHAR(30),
modelo VARCHAR(30),
componente VARCHAR(50),
tiempo int,
km int,
inspeccion VARCHAR(50) DEFAULT 'Reemplazo');
...
create table coches (marca VARCHAR(30),
modelo VARCHAR(30),
...
/*
ALTER TABLE coches DROP CONSTRAINT coches_ibfk_1;
ALTER TABLE COCHES ADD CONSTRAINT fk_id FOREIGN KEY (owner_id) REFERENCES usuarios(id);
*/ 
